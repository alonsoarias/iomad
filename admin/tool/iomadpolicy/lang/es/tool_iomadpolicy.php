...
$string['activateconfirm'] = '<p>Está a punto de activar la política <em>\'{$a->name}\'</em> y hacer que la versión <em>\'{$a->revision}\'</em> sea la actual.</p><p>Todos los usuarios deberán aceptar esta nueva versión de la política para poder utilizar el sitio.</p>';
...
$string['nopermissiontoagreedocs_desc'] = 'Lo sentimos, no tiene los permisos necesarios para aceptar las políticas.<br />No podrá utilizar este sitio hasta que se acepten las siguientes políticas:';
