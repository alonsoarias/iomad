...
$string['activateconfirm'] = '<p>Está a punto de activar la política <em>\'{$a->name}\'</em> y establecer la versión <em>\'{$a->revision}\'</em> como la actual.</p><p>Todos los usuarios deberán aceptar esta nueva versión de la política para poder utilizar el sitio.</p>';
...
$string['declineacknowledgement'] = 'Reconozco que he recibido una solicitud para rechazar consentimiento en nombre del/de los usuario(s) mencionado(s).';
...
$string['errorsaveasdraft'] = 'Un cambio menor no se puede guardar como borrador';
...
$string['guestconsentmessage'] = 'Si continúa navegando este sitio web, acepta nuestras políticas:';
...
$string['minorchangeinfo'] = 'Un cambio menor no altera el significado de la política. No se requiere que los usuarios acepten la política nuevamente si la edición se marca como cambio menor.';
...
$string['nopermissiontoagreedocs_desc'] = 'Lo sentimos, no tiene los permisos requeridos para aceptar las políticas.<br />No podrá utilizar este sitio hasta que se acepten las siguientes políticas:';
...
$string['selectiomadpolicyandversion'] = 'Use el filtro arriba para seleccionar política y/o versión';
$string['steppolicies'] = 'Política {$a->numiomadpolicy} de {$a->totalpolicies}';
$string['pluginname'] = 'IOMAD Políticas';
...
$string['iomadpolicydocsummary_help'] = 'Este texto debe proporcionar un resumen de la política, potencialmente en forma simplificada y fácilmente accesible, utilizando lenguaje claro y sencillo.';
...
$string['privacy:metadata:acceptances'] = 'Información sobre acuerdos de políticas realizados por usuarios.';
$string['privacy:metadata:acceptances:iomadpolicyversionid'] = 'La versión de la política para la cual se otorgó consentimiento.';
...
$string['privacy:metadata:acceptances:lang'] = 'El idioma usado para mostrar la política cuando se otorgó consentimiento.';
$string['privacy:metadata:acceptances:usermodified'] = 'El usuario que otorgó consentimiento para la política, si se hizo en nombre de otro usuario.';
$string['privacy:metadata:acceptances:timecreated'] = 'La hora cuando el usuario aceptó la política.';
$string['privacy:metadata:acceptances:timemodified'] = 'La hora cuando el usuario actualizó su acuerdo.';
...
$string['privacy:metadata:versions:timecreated'] = 'La hora en que esta versión de la política fue creada.';
$string['privacy:metadata:versions:timemodified'] = 'La hora en que esta versión de la política fue actualizada.';
$string['privacy:metadata:versions:iomadpolicyid'] = 'La política a la que esta versión está asociada.';
...
$string['readiomadpolicy'] = 'Por favor lea nuestra {$a}';
$string['refertofulliomadpolicytext'] = 'Por favor consulte la {$a} completa si desea revisar el texto.';
$string['response'] = 'Respuesta';
$string['responseby'] = 'Respondido por';
$string['responseon'] = 'Fecha';
$string['revokeacknowledgement'] = 'Reconozco que he recibido una solicitud para retirar consentimiento en nombre del/de los usuario(s) mencionado(s).';
$string['save'] = 'Guardar';
$string['saveasdraft'] = 'Guardar como borrador';
$string['selectuser'] = 'Seleccionar usuario {$a}';
$string['selectusersforconsent'] = 'Seleccionar usuarios para dar consentimiento en su nombre.';
