...
if ($mform->is_cancelled()) {
    ...
    $params = [
        ...
        'loginsmax' => $data->loginsmax,
        'courseaccessmin' => $data->courseaccessmin,
        'courseaccessmax' => $data->courseaccessmax,
        'activityaccessmin' => $data->activityaccessmin,
        'activityaccessmax' => $data->activityaccessmax,
