...
class email_template {
    ...
    public static function get_placeholders_config(): array {
        return [
            ...
            '_common' => [
                '{user_fullname}' => get_string('ph_user_fullname', 'local_jobboard'),
                '{user_firstname}' => get_string('ph_user_firstname', 'local_jobboard'),
                '{user_lastname}' => get_string('ph_user_lastname', 'local_jobboard'),
                '{user_email}' => get_string('ph_user_email', 'local_jobboard'),
                '{site_name}' => get_string('ph_site_name', 'local_jobboard'),
                '{site_url}' => get_string('ph_site_url', 'local_jobboard'),
                '{current_date}' => get_string('ph_current_date', 'local_jobboard'),
                '{company_name}' => get_string('ph_company_name', 'local_jobboard'),
            ],

            // Application templates.
            self::CODE_APPLICATION_RECEIVED => [
                '{vacancy_code}' => get_string('ph_vacancy_code', 'local_jobboard'),
                '{vacancy_title}' => get_string('ph_vacancy_title', 'local_jobboard'),
                '{application_id}' => get_string('ph_application_id', 'local_jobboard'),
                '{application_url}' => get_string('ph_application_url', 'local_jobboard'),
                '{submit_date}' => get_string('ph_submit_date', 'local_jobboard'),
            ],
            ...
            self::CODE_UNDER_REVIEW => [
                ...
                '{vacancy_title}' => get_string('ph_vacancy_title', 'local_jobboard'),
                '{application_url}' => get_string('ph_application_url', 'local_jobboard'),
                '{reviewer_name}' => get_string('ph_reviewer_name', 'local_jobboard'),
            ],
            ...
            self::CODE_DOCS_VALIDATED => [
                ...
                '{vacancy_title}' => get_string('ph_vacancy_title', 'local_jobboard'),
                '{application_url}' => get_string('ph_application_url', 'local_jobboard'),
                '{documents_count}' => get_string('ph_documents_count', 'local_jobboard'),
            ],

            self::CODE_DOCS_REJECTED => [
                '{vacancy_code}' => get_string('ph_vacancy_code', 'local_jobboard'),
                '{vacancy_title}' => get_string('ph_vacancy_title', 'local_jobboard'),
                '{rejected_docs}' => get_string('ph_rejected_docs', 'local_jobboard'),
                '{observations}' => get_string('ph_observations', 'local_jobboard'),
                '{application_url}' => get_string('ph_application_url', 'local_jobboard'),
                '{resubmit_deadline}' => get_string('ph_resubmit_deadline', 'local_jobboard'),
            ],

            self::CODE_REVIEW_COMPLETE => [
                '{vacancy_code}' => get_string('ph_vacancy_code', 'local_jobboard'),
                '{vacancy_title}' => get_string('ph_vacancy_title', 'local_jobboard'),
                '{review_summary}' => get_string('ph_review_summary', 'local_jobboard'),
                '{approved_count}' => get_string('ph_approved_count', 'local_jobboard'),
                '{rejected_count}' => get_string('ph_rejected_count', 'local_jobboard'),
                '{action_required}' => get_string('ph_action_required', 'local_jobboard'),
                '{application_url}' => get_string('ph_application_url', 'local_jobboard'),
            ],
            ...
            self::CODE_INTERVIEW_SCHEDULED => [
                '{vacancy_code}' => get_string('ph_vacancy_code', 'local_jobboard'),
                '{vacancy_title}' => get_string('ph_vacancy_title', 'local_jobboard'),
                '{interview_date}' => get_string('ph_interview_date', 'local_jobboard'),
                '{interview_time}' => get_string('ph_interview_time', 'local_jobboard'),
                '{interview_location}' => get_string('ph_interview_location', 'local_jobboard'),
                '{interview_type}' => get_string('ph_interview_type', 'local_jobboard'),
                '{interview_duration}' => get_string('ph_interview_duration', 'local_jobboard'),
                '{interview_notes}' => get_string('ph_interview_notes', 'local_jobboard'),
                '{interviewer_name}' => get_string('ph_interviewer_name', 'local_jobboard'),
            ],
            ...
            self::CODE_INTERVIEW_REMINDER => [
                ...
                '{interview_time}' => get_string('ph_interview_time', 'local_jobboard'),
                '{interview_location}' => get_string('ph_interview_location', 'local_jobboard'),
                '{hours_until}' => get_string('ph_hours_until', 'local_jobboard'),
            ],

            self::CODE_INTERVIEW_COMPLETED => [
                '{vacancy_code}' => get_string('ph_vacancy_code', 'local_jobboard'),
                '{vacancy_title}' => get_string('ph_vacancy_title', 'local_jobboard'),
                '{interview_feedback}' => get_string('ph_interview_feedback', 'local_jobboard'),
                '{next_steps}' => get_string('ph_next_steps', 'local_jobboard'),
            ],
            ...
            self::CODE_SELECTED => [
                '{vacancy_code}' => get_string('ph_vacancy_code', 'local_jobboard'),
                '{vacancy_title}' => get_string('ph_vacancy_title', 'local_jobboard'),
                '{selection_notes}' => get_string('ph_selection_notes', 'local_jobboard'),
                '{next_steps}' => get_string('ph_next_steps', 'local_jobboard'),
                '{contact_info}' => get_string('ph_contact_info', 'local_jobboard'),
            ],

            self::CODE_REJECTED => [
                '{vacancy_code}' => get_string('ph_vacancy_code', 'local_jobboard'),
                '{vacancy_title}' => get_string('ph_vacancy_title', 'local_jobboard'),
                '{rejection_reason}' => get_string('ph_rejection_reason', 'local_jobboard'),
                '{feedback}' => get_string('ph_feedback', 'local_jobboard'),
            ],

            self::CODE_WAITLIST => [
                '{vacancy_code}' => get_string('ph_vacancy_code', 'local_jobboard'),
                '{vacancy_title}' => get_string('ph_vacancy_title', 'local_jobboard'),
                '{waitlist_position}' => get_string('ph_waitlist_position', 'local_jobboard'),
                '{notification_note}' => get_string('ph_notification_note', 'local_jobboard'),
            ],
            ...
            self::CODE_VACANCY_CLOSING => [
                '{vacancy_code}' => get_string('ph_vacancy_code', 'local_jobboard'),
                '{vacancy_title}' => get_string('ph_vacancy_title', 'local_jobboard'),
                '{days_remaining}' => get_string('ph_days_remaining', 'local_jobboard'),
                '{close_date}' => get_string('ph_close_date', 'local_jobboard'),
                '{vacancy_url}' => get_string('ph_vacancy_url', 'local_jobboard'),
            ],

            self::CODE_NEW_VACANCY => [
                '{vacancy_code}' => get_string('ph_vacancy_code', 'local_jobboard'),
                '{vacancy_title}' => get_string('ph_vacancy_title', 'local_jobboard'),
                '{vacancy_description}' => get_string('ph_vacancy_description', 'local_jobboard'),
                '{open_date}' => get_string('ph_open_date', 'local_jobboard'),
                '{close_date}' => get_string('ph_close_date', 'local_jobboard'),
                '{vacancy_url}' => get_string('ph_vacancy_url', 'local_jobboard'),
                '{faculty_name}' => get_string('ph_faculty_name', 'local_jobboard'),
            ],

            self::CODE_REVIEWER_ASSIGNED => [
                '{vacancy_code}' => get_string('ph_vacancy_code', 'local_jobboard'),
                '{vacancy_title}' => get_string('ph_vacancy_title', 'local_jobboard'),
                '{applicant_name}' => get_string('ph_applicant_name', 'local_jobboard'),
                '{application_url}' => get_string('ph_application_url', 'local_jobboard'),
                '{documents_count}' => get_string('ph_documents_count', 'local_jobboard'),
                '{deadline}' => get_string('ph_deadline', 'local_jobboard'),
            ],
        ];
    }
