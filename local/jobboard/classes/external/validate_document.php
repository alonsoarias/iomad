...
/**
 * External API for validating (approving) a document.
 *
 * Only HR and Admin can validate documents. Dean role cannot.
 *
 ...
 */
class validate_document extends external_api {
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            'documentid' => new external_value(PARAM_INT, 'The document ID to validate'),
     ...
     */
    public static function execute(int $documentid, int $applicationid): array {
        global $USER;
        ...
        // Dean role cannot validate individual documents - only approve/reject entire applications.
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => get_string('documentvalidated', 'local_jobboard'),
                'documentid' => $params['documentid'],
                'newstatus' => 'approved',
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            ...
            'documentid' => new external_value(PARAM_INT, 'The document ID that was validated'),
