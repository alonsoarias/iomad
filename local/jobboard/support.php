...
for ($i = 1; $i <= 4; $i++) {
    $examples[] = [
        'text' => get_string("support_example_{$i}", 'local_jobboard'),
    ];
}
...
// Display the page using Mustache template.
echo $OUTPUT->header();
echo $OUTPUT->render_from_template('local_jobboard/pages/support/index', $templatecontext);
echo $OUTPUT->footer();
