...
// ============================================================================
// MODE: SHOW SINGLE VACANCY DETAIL (Same design as vacancy.php)
// ============================================================================
if ($vacancyid > 0) {
    // Get the vacancy.
    ...
    // ========================================================================
    // PAGE HEADER (Breadcrumbs like vacancy.php)
    // ========================================================================
    $breadcrumbs = [
    ...
    echo html_writer::start_div('d-flex flex-wrap justify-content-center gap-2');
