...
$string['deletegroupcheckfull'] = '¿Desea eliminar el grupo {$a}? Esto también eliminará a los usuarios asociados a este grupo.';
...
$string['resetschedulecheckfull'] = '¿Desea restablecer por completo la programación de {$a}?';
