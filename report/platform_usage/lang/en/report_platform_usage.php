...
$string['exportpdf'] = 'Download as PDF';
...
$string['totallogins'] = 'Total logins';
$string['avgperday'] = 'Avg. per day';
$string['avgperuser'] = 'Avg. per user';
$string['uniquecourses'] = 'Unique courses';
$string['lastday'] = 'Last day';
$string['totaldaysdata'] = 'Days in range';
$string['days'] = 'days';
...
// Privacy and GDPR.
$string['privacy:metadata'] = 'The Platform Usage Report plugin stores user dedication time data.';
$string['privacy:metadata:report_platform_usage_ded'] = 'Information about time spent by users in each course.';
$string['privacy:metadata:report_platform_usage_ded:userid'] = 'The ID of the user whose dedication time is recorded.';
$string['privacy:metadata:report_platform_usage_ded:courseid'] = 'The ID of the course where time was spent.';
$string['privacy:metadata:report_platform_usage_ded:timespent'] = 'The total time spent in seconds.';
$string['privacy:metadata:report_platform_usage_ded:timestart'] = 'The timestamp of the calculation period start.';
