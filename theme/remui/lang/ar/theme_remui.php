...
<br><br>
لإدارة التذييل مباشرة في مُخصص الواجهة المرئية، <a href="' . $CFG->wwwroot . '/theme/remui/customizer.php?url=' . $CFG->wwwroot . '/my/index.php">اضغط هنا</a>.</p></div></div>';
...
$string['footerpersonalizerinfo'] = 'لقد نقلنا جميع إعدادات التذييل إلى "المُخصص البصري" لسهولة الوصول وتحسين سهولة الاستخدام عبر موقعك.<br><br> من الآن فصاعدًا يمكنك إدارة إعدادات التذييل مباشرة في <a class="btn btn-primary btn-sm" href="'.$CFG->wwwroot.'/theme/remui/customizer.php?url='.$CFG->wwwroot. '/my/index.php" >المُخصص البصري</a>.';
