...
<br><br>
Para gerenciar seu rodapé diretamente no Personalizador Visual, <a href="' . $CFG->wwwroot . '/theme/remui/customizer.php?url=' . $CFG->wwwroot . '/my/index.php">clique aqui</a>.</p></div></div>';
...
$string['footerpersonalizerinfo'] = 'Realocamos todas as configurações de rodapé para o "Personalizador visual" para facilitar o acesso e melhorar a usabilidade em todo o site.<br><br> Agora você pode gerenciar o rodapé diretamente no <a class="btn btn-primary btn-sm" href="'.$CFG->wwwroot.'/theme/remui/customizer.php?url='.$CFG->wwwroot. '/my/index.php" >Personalizador visual</a>.';
