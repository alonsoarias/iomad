...
<br><br>
Pour gérer directement votre pied de page dans le Personnalisateur visuel, <a href="' . $CFG->wwwroot . '/theme/remui/customizer.php?url=' . $CFG->wwwroot . '/my/index.php">cliquez ici</a>.</p></div></div>';
