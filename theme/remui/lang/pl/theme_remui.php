...
<br><br>
Aby zarządzać stopką bezpośrednio w Personalizatorze wizualnym, <a href="' . $CFG->wwwroot . '/theme/remui/customizer.php?url=' . $CFG->wwwroot . '/my/index.php">kliknij tutaj</a>.</p></div></div>';
...
$string['footerpersonalizerinfo'] = 'Przenieśliśmy wszystkie ustawienia stopki do "Personalizatora wizualnego" dla łatwiejszego dostępu i lepszej użyteczności w całym serwisie.<br><br> Od teraz możesz zarządzać stopką bezpośrednio w <a class="btn btn-primary btn-sm" href="'.$CFG->wwwroot.'/theme/remui/customizer.php?url='.$CFG->wwwroot. '/my/index.php" >Personalizatorze wizualnym</a>.';
