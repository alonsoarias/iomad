...
<br><br>
Um Ihre Fußzeile direkt im Visuellen Personalisierer zu verwalten, <a href="' . $CFG->wwwroot . '/theme/remui/customizer.php?url=' . $CFG->wwwroot . '/my/index.php">klicken Sie hier</a>.</p> </div></div>';
...
$string['footerpersonalizerinfo'] = 'Wir haben alle Fußzeileneinstellungen in den "Visuellen Personalisierer" verlegt, um den Zugriff zu erleichtern und die Benutzerfreundlichkeit auf Ihrer Website zu verbessern.<br><br> Ab jetzt können Sie Ihre Fußzeileneinstellungen direkt im verwalten. <a class="btn btn-primary btn-sm" href="'.$CFG->wwwroot.'/theme/remui/customizer.php?url='.$CFG->wwwroot. '/my/index.php" >Visuellen Personalisierer</a> ';
