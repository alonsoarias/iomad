...
/**
 * Plugin renderer for theme_inteb.
 *
 * Provides custom rendering functionality for the INTEB theme,
 * including certificate rendering capabilities.
 *
 * @package     theme_inteb
 * @category    output
...
/**
 * Theme renderer class for theme_inteb.
 *
 * @package     theme_inteb
 * @copyright   2025 Vicerrectoría Académica ISER <vicerrectoria@iser.edu.co>
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
