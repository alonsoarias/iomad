...
/**
 * Theme settings utility class for theme_inteb.
 *
 * Provides utility methods for handling footer settings, personal area header,
 * and my courses header configurations. Supports GOV.CO compatible footer design.
 *
 * @package     theme_inteb
 * @category    util
