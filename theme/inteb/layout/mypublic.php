...
/**
 * Public profile layout for theme_inteb.
 *
 * A drawer based layout extending RemUI for user public profile pages
 * with badges, interests, courses, and certificates support.
 *
 * @package     theme_inteb
