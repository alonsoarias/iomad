...
/**
 * Frontpage layout for theme_inteb.
 *
 * A drawer based layout extending RemUI for the site front page
 * with slider, about us, testimonials, and blog sections support.
 *
 * @package     theme_inteb
